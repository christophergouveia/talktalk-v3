      ...
      >
        ...
        <div
          className={`absolute w-0 h-0 setinha${
            ownMessage
              ? "-own after:border-t-transparent after:border-r-transparent after:border-b-slate-300 after:border-l-transparent dark:after:border-b-slate-600 rounded-lg"
              : ""
