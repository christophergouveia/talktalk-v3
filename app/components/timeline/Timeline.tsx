...
const Timeline: FC<TimelineProps> = ({ events, className = '' }) => {
  return (
    <div className={`max-w-7xl mx-auto py-8 px-2 sm:px-4 ${className}`}>{/* Timeline container */}
      <div className="relative">
        {/* Timeline start decoration */}        <motion.div
        ...
        {/* Timeline end decoration */}        <motion.div
        ...
        </motion.div>        {/* Timeline events with improved mobile spacing */}
        <div className="relative space-y-6 sm:space-y-8 md:space-y-12 pt-8 pb-8">
          {/* Linha de fundo contínua para conectar todos os itens - estende completamente até os ícones */}
          <motion.div 
