...
export default function Home({}) {
  return (
    <>
      ...
      `}</style>
      <Marquee autoFill className="pt-6 h-fit overflow-hidden text-2xl  2xl:text-3xl mb-12">
      ...
      <section className="flex items-center justify-center px-3 h-full">
        <div className="text-center flex justify-center items-center">
          <div>
          <h1 className={`${anton.className} sm:text-8xl text-2xl font-bold mb-4 bg-gradient-to-r from-[#38A3F5] to-[#6F90F2] !leading-[1.2] text-transparent bg-clip-text`}>
            TalkTalk!
          </h1>
          <p className="text-2xl mb-8 text-gray-700 dark:text-gray-500">
          ...
          <Link href="/conversar" className="bg-gradient-to-r from-[#38A3F5] to-[#6F90F2] hover:bg-blue-700 transition-all shadow-2xl shadow-blue-600 text-white py-2 px-8 rounded hover:scale-105">
